...
<head>
   ...
   <!-- 댓글달기 -->
        ...
        <tr>
         <td colspan="2" align="right">
          <input name="list" type="button" value="수정" class="inputb" onClick="javascript:location.href='ModifyForm.action?no=<s:property value="board_num" />&currentPage=<s:property value="currentPage" />'">
               
   <input name="list" type="button" value="삭제" class="inputb" onClick="javascript:location.href='AdminDeleteAction.action?no=<s:property value="board_num" />&currentPage=<s:property value="currentPage" />'">
