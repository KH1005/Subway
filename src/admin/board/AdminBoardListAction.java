...
public class AdminBoardListAction extends ActionSupport{
	
    public static Reader reader;
	public static SqlMapClient sqlMapper;
	
	private List<AdminboardVO> list = new ArrayList<AdminboardVO>();
	...
	public AdminBoardListAction() throws IOException
	{
	...
	public void setList(List<AdminboardVO> list) {
		this.list = list;
	}
